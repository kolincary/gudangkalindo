<!-- Aplikasi Persediaan Barang Gudang LT. 5 dengan PHP 8 dan MySQLi
************************************************************************
* Developer   : Johan Gilbeth
* Company     : Johan Gilbeth
* Release     : Desember 2024
* Update      : -
* Website     : -
* E-mail      : jgilbeth92@gmail.com
* WhatsApp    : -
-->
...
// jika user sudah login, tampilkan halaman konten
  ...
  <head>
    ...
    <meta name="description" content="Aplikasi Persediaan Barang Gudang LT. 5 dengan PHP 8 dan MySQLi" />
    <meta name="author" content="Johan Gilbeth" />

    <!-- Title -->
    <title>Aplikasi Persediaan Barang Gudang LT. 5 dengan PHP 8 dan MySQLi</title>
        ...
        <div class="logo-header" data-background-color="purple">
          ...
          <a href="?module=dashboard" class="logo">
            <div class="navbar-brand">
              ...
              <span class="text-white">udang Lantai 5</span>
            </div>
          </a>
          <!-- Navbar Toggler -->
        ...
        <footer class="footer">
          <div class="container-fluid">
            <div class="copyright ml-auto">
              Copyright &copy; 2024 - <a href="#" class="text-secondary">Johan Gilbeth</a>.
            </div>
          </div>
        </footer>
        <!-- End Footer -->
